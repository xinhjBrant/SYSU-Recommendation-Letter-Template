% This template is modified from FDU template: https://www.overleaf.com/latex/templates/fudan-recommendation-letter-template/rvptymhypfkz
...
\usepackage{tikz} 
\usepackage{xcolor}
	\definecolor{sysublue}{cmyk}{1,0,1,0.6}
\usepackage{lipsum}
\usepackage{fancyhdr}
\usepackage{lastpage}
\usepackage{eso-pic}
...
\def\Where{\hspace{-1.2mm}\textbf{\color{sysublue}%{sysublue}
Your School,\\ Sun Yat-sen University
}} 
%%%%%%%%%%%%  Additional Contact Information %%%%%%%%%%%
%
% Set your preferred primary contact address here.
\def\Address{No.135, Xingang Xi RD\\
Haizhu District,} 
%
\def\CityZip{Guangzhou, 510275} 
%
% Set your SYSU e-mail here
\def\Email{\textbf{\color{sysublue}E-mail}: xxx@sysu.edu.cn}
%
% Set your preferred contact number here
\def\TEL{\textbf{\color{sysublue}Phone}: 020-84112828}
%
% Set your department or personal website here
\def\URL{\textbf{\color{sysublue}URL}: http://www.sysu.edu.cn/}
%
%%%%%%%%%%%%%%%%  Footer information  %%%%%%%%%%%%%%%%%%
%
